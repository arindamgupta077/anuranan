...
Write-Host "Generating improved icons..." -ForegroundColor Cyan

$dir = Join-Path $PSScriptRoot "website\public"
if (-not (Test-Path $dir)) {
    New-Item -ItemType Directory -Path $dir | Out-Null
}

try {
    Create-RoundIcon -Size 192 -OutputPath (Join-Path $dir "icon-192.png")
    Create-RoundIcon -Size 512 -OutputPath (Join-Path $dir "icon-512.png")
